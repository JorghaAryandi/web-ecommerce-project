            ...
            <div class="col-lg-11 col-xl-9 col-xxl-8">
                <section>
                    ...
                    <div>
                        ...
                        <div v-else>
                            <div class="card shadow border-0 rounded-4 mb-5" v-for="(invoice, index) in invoices" :key="index">
                                <div class="card-body p-5">
                                    <div class="row align-items-center gx-5">
                                        <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                            <div class="bg-light p-4 rounded-4">
                                                <div class="text-primary fw-bolder mb-2">{{ invoice.id }}</div>
                                                ...
                                                <!-- Total harga invoice -->
                                                <div class="fw-bolder text-end">Total: ${{ invoice.totalPrice.toFixed(2) }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
